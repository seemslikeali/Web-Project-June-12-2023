            ...
            <div
              ...
              <div className="flex h-full items-center justify-center">
                <div className="px-6 text-center text-white md:px-12">
                  ...
                  />
                  <h2 className='pb-16 drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] mb-10 my-2 m-auto text-l flex items-center justify-center text-center font-bold w-3/5 2xl:w-[95%] dark:text-light'>

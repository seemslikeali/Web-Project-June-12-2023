...
import { TwitterIcon, GithubIcon, LinkedInIcon, YoutubeIcon, SunIcon, MoonIcon } from "./Icons"
...
const CustomMobilesLink = ({ href, title, className = "", toggle }) => {
    const router = useRouter();
    ...
    ${mode === "light" ? "bg-dark text-light" : "bg-light text-dark"}`}
            ...
            z-30 bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md py-32'>
                        ...
                        <nav className='flex items-center flex-col justify-center'>
                            ...
                            <CustomMobilesLink href={"/"} title="Home" className='' toggle={handleClick} />
                            <CustomMobilesLink href={"/about"} title="About" className='' toggle={handleClick} />
                            <CustomMobilesLink href={"/projects"} title="Projects" className='' toggle={handleClick} />
                            <CustomMobilesLink href={"/articles"} title="Articles" className='' toggle={handleClick} />
